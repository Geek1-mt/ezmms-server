/*
 ...
 Source Schema         : web_emss

 Target Server Type    : MySQL
 Target Server Version : 80021
 File Encoding         : 65001

 Date: 16/03/2023 03:04:30
*/
...
-- ----------------------------
INSERT INTO `administrators` VALUES (1, 'admin', 'a163a36c731d1ac664841b6d196a05e3');
...
CREATE TABLE `cart`  (
  ...
  `thumb_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `price` decimal(10, 0) NULL DEFAULT NULL,
  `buy_count` int(0) NULL DEFAULT NULL,
  `is_pay` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_id` int(0) NOT NULL,
  `counts` int(0) NULL DEFAULT NULL
...
CREATE TABLE `category`  (
  ...
  `cate_icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `cate_counts` int(0) NULL DEFAULT NULL,
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '图书影像', 'el-icon-reading', 2);
INSERT INTO `category` VALUES (2, '家居生活', 'el-icon-box', 19);
INSERT INTO `category` VALUES (3, '服饰箱包', 'el-icon-present', 20);
INSERT INTO `category` VALUES (4, '电子数码', 'el-icon-mobile-phone', 10);
...
CREATE TABLE `comments`  (
  ...
  `goods_id` int(0) NOT NULL,
  `comment_detail` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `comment_rating` int(0) NULL DEFAULT NULL,
  `user_id` int(0) NOT NULL,
...
INSERT INTO `comments` VALUES (26, 621723438, '一般', 3, 9);
INSERT INTO `comments` VALUES (27, 621723438, '可以一读', 4, 1);
INSERT INTO `comments` VALUES (47, 621723438, '不错', 3, 1);
INSERT INTO `comments` VALUES (48, 10519372, '不错', 4, 1);
INSERT INTO `comments` VALUES (49, 621723438, '1\n\n\n', 3, 1);
...
-- ----------------------------
INSERT INTO `homebanner` VALUES (1, 'http://localhost:3000/images/home/s1.png', 'http://mobile.yangkeduo.com/subject.html?subject_id=6153');
INSERT INTO `homebanner` VALUES (2, 'http://localhost:3000/images/home/s2.png', 'http://mobile.yangkeduo.com/promotion_op.html?type=12&id=228');
INSERT INTO `homebanner` VALUES (3, 'http://localhost:3000/images/home/s3.png', 'http://mobile.yangkeduo.com/subject.html?subject_id=6242');
INSERT INTO `homebanner` VALUES (4, 'http://localhost:3000/images/home/s4.png', 'http://mobile.yangkeduo.com/subject.html?subject_id=6153');
INSERT INTO `homebanner` VALUES (5, 'http://localhost:3000/images/home/s5.png', 'http://mobile.yangkeduo.com/subject.html?subject_id=6230');
INSERT INTO `homebanner` VALUES (6, 'http://localhost:3000/images/home/s6.png', 'http://mobile.yangkeduo.com/promotion_op.html?type=12&id=190');
INSERT INTO `homebanner` VALUES (7, 'http://localhost:3000/images/home/s7.png', 'http://mobile.yangkeduo.com/promotion_op.html?type=12&id=229');
INSERT INTO `homebanner` VALUES (8, 'http://localhost:3000/images/home/s8.png', 'http://mobile.yangkeduo.com/subject.html?subject_id=6153');
INSERT INTO `homebanner` VALUES (9, 'http://localhost:3000/images/home/s9.png', 'http://mobile.yangkeduo.com/subject.html?subject_id=6242');
...
CREATE TABLE `recommend`  (
  ...
  `goods_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `short_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `thumb_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `hd_thumb_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `image_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `price` int(0) NULL DEFAULT NULL,
  `normal_price` int(0) NULL DEFAULT NULL,
  `market_price` int(0) NULL DEFAULT NULL,
  `sales_tip` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `recommend` VALUES (1031855, '【甜曲】紫米面包550g/2200g黑米夹心奶酪蛋糕减脂早餐营养代餐', '甜曲紫米面包600g', 'http://t00img.yangkeduo.com/goods/images/2018-08-30/1093ac9bfaa77304a8c3f25d4bfcb743.jpeg', 'http://t00img.yangkeduo.com/goods/images/2018-08-30/41793c7556c00d972886f53de1bd58f5.jpeg', 'http://t00img.yangkeduo.com/goods/images/2018-08-30/177c3a7ebdffad8a008976988322ba8f.jpeg', 1000, 1680, 6950, '已售10万+件', 5, 60, 0);
INSERT INTO `recommend` VALUES (2316452, '秋季牛仔裤男青年修身弹力小脚裤2018新款韩版潮流男士小直筒长裤', '男士修身弹力小脚裤 品质保证', 'http://t00img.yangkeduo.com/t11img/images/2018-07-15/6982d3a77481e146e9fb81dc31d3a546.jpeg', 'http://t00img.yangkeduo.com/t10img/images/2018-07-15/aa4c5248112bdc08cc2faec10b1ad2a7.jpeg', 'http://t00img.yangkeduo.com/t10img/images/2018-06-25/667b2fcd41a6a1450cc29aac5bb8507f.jpeg', 2800, 3200, 26900, '已售2万件', 3, 102, 0);
INSERT INTO `recommend` VALUES (6096094, '【金贤】防风不锈钢8/16/20/30/40夹袜架晾袜衣架内衣夹晾晒架', '不锈钢加粗防风袜架可晒毛巾衣架晾晒衣夹', 'http://t00img.yangkeduo.com/t07img/images/2018-05-16/f6bbac2f073efed1b2aa7b6b1dfeb95f.jpeg', 'http://t00img.yangkeduo.com/t02img/images/2018-05-16/f2171b871216528c66388163024bb5fc.jpeg', 'http://t00img.yangkeduo.com/goods/images/2018-08-23/ed5a60f13860e5f52c21a97125c8f72a.jpeg', 490, 790, 5500, '已售10万+件', 2, 502, 0);
...
INSERT INTO `recommend` VALUES (50783155, '【南极人】肤色加绒加厚打底裤女光腿神器秋冬外穿保暖裤子连体裤', '加绒加厚打底踩脚裤保暖一体裤连裤袜', 'http://t00img.yangkeduo.com/t01img/images/2018-06-01/4d0c2a4168c2c8ea2053b1ba44e342cf.jpeg', 'http://t00img.yangkeduo.com/t01img/images/2018-06-01/1a984c0b71d4b3f5dd3e9a4a38a2429c.jpeg', 'http://t00img.yangkeduo.com/goods/images/2018-09-10/6db1b848614c4b8730c0ad5507c7637f.jpeg', 1990, 4990, 9900, '已售10万+件', 3, 48, 0);
...
INSERT INTO `recommend` VALUES (65676090, 'USB可充电电子称体重秤精准家用健康秤人体秤成人减肥称重计器准', '精准家用健康人体秤/称重计', 'http://t00img.yangkeduo.com/t07img/images/2018-06-15/eccb3df7c0c6f180ebd0ec3fe755dae8.jpeg', 'http://t00img.yangkeduo.com/t08img/images/2018-06-15/b47b12272db838b8c72eb4b9a938aaac.jpeg', 'http://t00img.yangkeduo.com/t08img/images/2018-04-18/fc603bad27947c7adcdf1baae828cb34.jpeg', 7980, 3500, 16800, '已售10万+件', 2, 50, 2);
...
INSERT INTO `recommend` VALUES (621723438, '正版包邮 别在吃苦的年纪选择安逸 青春励志文学畅销排行榜书籍', '青春励志文学', 'https://img.alicdn.com/bao/uploaded/i2/322791652/O1CN013AKYLl1O4ewgcfx3l_!!0-item_pic.jpg', 'http://t00img.yangkeduo.com/goods/images/2018-07-20/1cd421b6d97de18dcfb0d3f7e6e5de94.jpeg', 'http://t00img.yangkeduo.com/goods/images/2018-07-20/671c3d632d8a08804d754d423f3d1f11.jpeg', 980, 1280, 13380, '已售1000+件', 1, 478, 24);
...
CREATE TABLE `user_info`  (
  ...
  `user_sex` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_birthday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_sign` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `user_balance` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 'luo', 'a163a36c731d1ac664841b6d196a05e3', '12345678910', '男', '地球的某一处', '2022-12-10', '康米', 'luo123', 'http://localhost:3000/avatar_uploads/upload_49dcd5f127b2f25b9b297d763357cd39.jpeg', 1260);
INSERT INTO `user_info` VALUES (5, 'li', 'd1c935942a8ccffaebafe30dc68dbe1e', NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:3000/avatar_uploads/avatar_default.jpg', NULL);
INSERT INTO `user_info` VALUES (8, 'xiaozhang', 'a163a36c731d1ac664841b6d196a05e3', NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:3000/avatar_uploads/avatar_default.jpg', NULL);
INSERT INTO `user_info` VALUES (9, 'xiaoming', 'a163a36c731d1ac664841b6d196a05e3', NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:3000/avatar_uploads/avatar_default.jpg', NULL);
INSERT INTO `user_info` VALUES (27, 'luo1', 'a163a36c731d1ac664841b6d196a05e3', NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:3000/avatar_uploads/avatar_default.jpg', NULL);
INSERT INTO `user_info` VALUES (29, 'km', 'a163a36c731d1ac664841b6d196a05e3', NULL, NULL, NULL, NULL, NULL, NULL, 'http://localhost:3000/avatar_uploads/avatar_default.jpg', 4000);
